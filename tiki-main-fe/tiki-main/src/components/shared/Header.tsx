...
export const Header = () => {
  ...
  const handleSubmit = async () => {
    ...
    if(sentOtp && password != ''){
      try {
        const response:any = await login(identifier, password);
        ...
        if(response.data.errorCode === "0" ){
            ...
            console.log(localStorage.getItem("token"),"token saved")
            ...
            <div className='p-16 flex flex-col mb-5 w-[70%]'>
              <div className='flex flex-col gap-5 mb-20'>
                ...
                {sentOtp && (
                  ...
                  type='password'
                  className='outline-none border-b border-blue-500 py-2 text-2xl w-full'
                  placeholder='Vui lòng nhập OTP được gửi về số điện thoại!'
                ...
                <div onClick={handleSubmit} className=' cursor-pointer bg-red-500 p-2 text-white rounded-md flex items-center justify-center text-xl'>
                  Tiếp Tục
                </div>
