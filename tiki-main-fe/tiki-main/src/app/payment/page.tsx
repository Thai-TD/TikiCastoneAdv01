...
export default function Page() {
  ...
  const getShippingAndPaymentInfo = () => {
    return {
  ...
  const handleOrderSubmission = () => {
    const info = getShippingAndPaymentInfo();
    console.log('Your Selected Shipping and Payment Info:', info);
    //API*** logic
  };
      ...
      <div className='w-[75%] flex flex-col gap-5'>
        <div className='bg-white p-4 rounded-md'>
          ...
          <div className='w-[50%] bg-sky-100 rounded-lg p-5 flex flex-col gap-5'>
            <Radio.Group onChange={(e) => setSelectedShipping(e.target.value)} value={selectedShipping} className='flex flex-col gap-5' size={'small'}>
              <Radio value={1}>
              ...
              <Radio onChange={(e) => setSelectedPayment(e.target.value)} value={selectedPayment}>
        ...
        <div className='bg-white  rounded-md'>
          ...
          <div className='p-4'>
            <div className='flex flex-col gap-2'>
              ...
              <div className='flex items-center justify-center text-white bg-red-500 p-2 rounded-md' onClick={handleOrderSubmission}>
                Đặt hàng
              </div>
            </div>
          </div>
